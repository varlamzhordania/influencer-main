        ...
        <div className="flex md:flex-row flex-col  justify-start mt-10 md:mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <p className={` text-[16px]`}>
              To kickstart your influencer collaboration journey in Canada, it's
              crucial to establish clear goals for your marketing campaign
              specific to this market. Determine whether you're aiming for brand
              awareness, product promotion, increased sales, or other specific
              outcomes within the Canadian context. By defining your objectives
              for the Canadian market, you'll be able to identify suitable
              Canadian influencers and align your collaborative efforts
              accordingly.
            </p>
            <button
              style={{
