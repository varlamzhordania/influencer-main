...
const ElevateTestimonials = () => {
  return (
    <div>
      <Wrapper>
        <div className="flex flex-col md:flex-row  justify-start my-28 md:mt-28 md:mb-32 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <p className={` text-[16px]`}>
              ...
              planning, organization, and amplification of Elevate marketing
...
export default ElevateTestimonials;
