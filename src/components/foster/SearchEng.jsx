        ...
        <div className="flex md:flex-row flex-col  justify-start md:mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <p className={` text-[16px]`}>
              <br />Move beyond the daunting realm of spreadsheets; upload or create your cloud-based database of influencers on Influent.ca, centralizing all your influencer management endeavors.
            </p>
