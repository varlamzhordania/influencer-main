            ...
            <Wrapper>
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    ...
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        Real-Time Engagement Status Monitoring
                        </h1>
                        <p className={` text-[16px]`}>
                        Stay abreast of the engagement status with influencers, keeping your influencer marketing campaigns well-coordinated and on track.</p>
