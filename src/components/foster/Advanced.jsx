      ...
      <Wrapper>
        <div className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            Transition from one-off campaigns to nurturing enduring relationships with influencers, embedding influencer marketing as a steadfast stack in your digital marketing strategy.
              {" "}
            </p>
          </div>
