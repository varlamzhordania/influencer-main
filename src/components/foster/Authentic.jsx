            ...
            <Wrapper>
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10 mb-16">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        Structured Contact Detail Management
                        </h1>
                        <p className={` text-[16px]`}>
                        Bid adieu to the chaos of scattered information; store and manage influencer contact details in a structured manner, all under one roof.</p>
