                ...
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        <h1 className={`${font.className} text-[32px] md:text-[36px] font-[700]`}>
                            Relationship Cultivation</h1>
                        <p className={` text-[16px]`}>
                            Embark on a journey of cultivating meaningful relationships with influencers, laying a robust foundation for collaborative marketing success.
                        </p>  </div>
