                ...
                <div className="flex flex-col h-[80vh] md:h-[80vh] sm:flex-col md:flex-col xl:flex-row 2xl:flex-row items-center justify-start ">
                    <div className="flex flex-col basis-[50%] justify-start items-start">
                        <h1 className="text-[32px] md:text-[40px] font-[700] text-center md:text-left tracking-tight pt-20 md:pt-0 md:pr-10">
                            Foster Lasting Influencer Partnerships with Relationship
                            Management
                        </h1>
                        <p className={`pt-4 ${font.className}  text-center md:text-left`}>
                            In the digital marketing frontier, influencer marketing has emerged as a cornerstone for brand amplification. However, navigating through the maze of influencer relationship management can often be a cumbersome endeavor. Influent.ca, your Canada-based influencer management platform, redefines this narrative by offering a seamless Influencer Relationship Management (IRM) feature.
                        </p>
