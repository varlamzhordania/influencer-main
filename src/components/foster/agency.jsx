                ...
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    ...
                    <div className="flex flex-col gap-3 md:w-1/2">
                        <h1 className={`${font2.className} text-[32px] md:text-[36px] font-[700] capitalize`}>
                            Centralized Creators Database
                        </h1>
                        <p className={` text-[16px]`}>

                            Harness the power of a centralized database of creators to bolster your paid media adverts, fostering a harmonized influencer-brand synergy right here in Canada.
                        </p>
