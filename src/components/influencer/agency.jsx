            ...
            <Wrapper>
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    ...
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        Holistic Profile Insight
                        </h1>
                        <p className={` text-[16px]`}>
                      
                        Delve deep into influencer profiles, exploring crucial metrics like age, gender, ensuring a harmonious alignment with your brands persona.</p>
