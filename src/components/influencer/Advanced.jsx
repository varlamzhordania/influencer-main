        ...
        <div className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <p className={` text-[16px]`}>
              Navigate through detailed audience demographics of potential influencers, covering aspects like age, gender, location, language, and ethnicity, to target the most receptive market segments.
              {" "}
            </p>
          </div>
