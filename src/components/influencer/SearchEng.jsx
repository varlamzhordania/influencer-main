      ...
      <Wrapper>
        <div className="flex md:flex-row flex-col  justify-start md:mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <br />Analyze engagement levels, trends, and the overall influence an influencer commands, to envision the potential reach and interaction of your campaigns. </p>
