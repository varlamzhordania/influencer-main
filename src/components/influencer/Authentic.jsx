            ...
            <Wrapper>
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        Brand Affinity Exploration
                        </h1>
                        <p className={` text-[16px]`}>
                        Understand an influencers brand affinity and interests, assessing how well they resonate with your brand values for meaningful collaborations.</p>
