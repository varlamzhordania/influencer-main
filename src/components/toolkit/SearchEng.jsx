        ...
        <div className="flex md:flex-row flex-col  justify-start md:mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <p className={` text-[16px]`}>
              In Canada, there's a noticeable shift towards nano- and micro-influencers. These influencers tend to have higher engagement rates, forging more authentic connections with their Canadian audiences.
            </p>
