                ...
                <div className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        <p className={` text-[16px]`}>
                            The Canadian influencer landscape has seen the emergence of creator-focused marketplaces that facilitate collaborations between influencers and brands.
                        </p>
