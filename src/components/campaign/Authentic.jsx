            ...
            <Wrapper>
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        Campaign Brief Uploading
                        </h1>
                        <p className={` text-[16px]`}>
                        Upload your campaign briefs effortlessly, providing Canadian influencers with crystal clear guidelines and expectations for harmonious campaign execution.
                        </p>
