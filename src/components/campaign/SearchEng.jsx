        ...
        <div className="flex md:flex-row flex-col  justify-start md:mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <p className={` text-[16px]`}>
              <br />Delve into real-time performance analytics, gaining immediate insights into your campaign's performance in the Canadian influencer market, and enabling data-driven optimizations.
