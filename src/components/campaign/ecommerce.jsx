            ...
            <Wrapper>
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10 mb-16">
                    ...
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        Content & Influencer Linking
                        </h1>
                        <p className={` text-[16px]`}>
                        Seamlessly link content and influencers, structuring a well-coordinated campaign framework for effective influencer marketing in Canada.</p>
