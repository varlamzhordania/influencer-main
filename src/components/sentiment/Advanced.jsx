      ...
      <Wrapper>
        <div className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            Engage with real-time sentiment analysis, capturing the pulse of public sentiment as it unfolds. Stay ahead of the curve by understanding how your audience feels about your brand at any given moment.
              {" "}
            </p>
          </div>
