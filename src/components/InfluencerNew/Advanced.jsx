...
const Advanced = () => {
  return (
    <div>
      <Wrapper>
        <div
          className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10"
          id="creators"
        >
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            <ul className="list-disc ml-5 text-lg flex flex-col space-y-1">
              <li>
                Access resources to elevate and professionalize your content.
              </li>
              <li>
                Collaborate with brands and fellow creators for wider reach.
              </li>
              <li>Monitor your growth and engagement metrics with ease.</li>
            </ul>
            <button
