            ...
            <Wrapper>
                <div className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        <p className={` text-[16px] pr-24`}>
                        Some influencers inflate their following with fake & inactive followers.affable.ai uses proprietary machine learning models to detect these influencers.
                        </p>
                    </div>
                    <div className="md:w-1/2 flex md:justify-end  md:ml-0">
                        ...
                        <Image
                            ...
                            width={800}
                            height={800}
                            className="w-[320px] absolute mt-[5rem] md:w-[500px]    rounded-[10px]"
                        />
