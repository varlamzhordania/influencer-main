                ...
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10">
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        <p className={` text-[16px]`}>
                            Stay informed on the progress of your campaigns with meticulous performance tracking. We monitor key metrics to gauge the effectiveness and reach of your influencer partnerships.
                        </p>
