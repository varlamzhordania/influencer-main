        ...
        <div className="flex md:flex-row flex-col  justify-start md:mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            <h1 className={`${font2.className} text-[36px] font-[700]`}>
              Remarkable Results, Less Complexities
            </h1>
            <p className={` text-[16px]`}>
              <br />Immerse in the remarkable results of well-executed influencer marketing campaigns, sans the complexities and time-consuming tasks, all while enjoying the convenience of direct communication with influencers.
            </p>
