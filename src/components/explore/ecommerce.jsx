                ...
                <div className="flex mt-20 flex-col md:flex-row-reverse  justify-start md:mt-20 items-center gap-10 mb-16">
                    ...
                    <div className="flex flex-col gap-3 md:w-1/2">
                        ...
                        <p className={` text-[16px]`}>
                            Receive detailed reports encapsulating the performance and ROI of your campaigns, granting you insightful data to evaluate the success and learnings from each influencer collaboration.</p>
