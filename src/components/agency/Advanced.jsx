      ...
      <Wrapper>
        <div className="flex md:flex-row flex-col  justify-start  mt-20 items-center gap-10">
          <div className="flex flex-col gap-3 md:w-1/2">
            ...
            Entrust your influencer marketing campaigns to our seasoned in-house social media marketing experts, who carry the torch from conception to execution, ensuring each campaign resonates with your brand ethos and reaches your target audience effectively
              {" "}
            </p>
          </div>
