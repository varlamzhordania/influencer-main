                ...
                <div className="flex flex-col h-[80vh] md:h-[80vh] sm:flex-col md:flex-col xl:flex-row 2xl:flex-row items-center justify-start ">
                    <div className="flex flex-col basis-[50%] justify-start items-start">
                        ...
                        <p className={`pt-4 ${font.className}  text-center md:text-left`}>
                            The influencer marketing ecosyastem often grapples with the absence of a customized industry-standard framework for meticulous tracking, analysis, and reporting on Key Performance Indicators (KPIs). Influent.ca steps in to fill this void, offering a robust feature for in-depth tracking, analysis, and reporting, tailored to meet the nuanced demands of influencer marketing campaigns.
                        </p>
